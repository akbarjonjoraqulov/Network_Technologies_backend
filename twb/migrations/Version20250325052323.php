 ...
 */
final class Version20250325052323 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Update User and MediaObject';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD videos JSON DEFAULT NULL COMMENT \'(DC2Type:json)\'');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE user DROP videos');
